...
export AZURE_OPENAI_DEPLOYMENT_NAME=gpt-5-mini # required if using Azure OpenAI
export AZURE_OPENAI_ENDPOINT=https://placeholder.openai.azure.com/ # required if using Azure OpenAI
export AZURE_OPENAI_API_VERSION=2024-12-01-preview # required if using Azure OpenAI
export TEMPERATURE=1 # optional, set the temperature for the generated descriptions, default is 1 for gpt-5-mini
